...
# About Page
    ...
    st.markdown('<h2 style="color: #667eea; margin-top: 56px; margin-bottom: 32px; text-align: center;">Testimonials</h2>', unsafe_allow_html=True)
    test_cols = st.columns(4)
    testimonials = [
        {"review": "★★★★★<br>Absolutely exceeded expectations. The AI solution was delivered on time and works flawlessly!",},
        {"review": "★★★★★<br>Professional, responsive, and highly skilled. Will definitely work with them again.",},
        {"review": "★★★★★<br>Stellar AI turned our ideas into reality. The automation saved us countless hours.",},
        {"review": "★★★★★<br>Modern design, robust backend, and great communication throughout the project.",},
    ]
    for i, t in enumerate(testimonials):
        with test_cols[i]:
            st.markdown(f"""
            <div style='background: rgba(255,255,255,0.07); border-radius: 18px; padding: 24px 18px; margin-bottom: 18px; border: 1px solid rgba(102,126,234,0.10); min-height: 120px; text-align: center;'>
                <span style='font-size: 1.5rem; color: #FFD700; letter-spacing: 2px;'>{t['review']}</span>
            </div>
            """, unsafe_allow_html=True)
...
# Projects Page
    ...
    projects = [
        ...
        },
        {
            ...
            "description": "Developed a fully automated sports analytics and prediction system featuring real-time data scraping, score prediction models, and daily automated updates for NBA, NFL, and college games.",
            "tech": ["Python", "APIs", "Pandas", "Scikit-learn", "BeautifulSoup", "Dash/Streamlit", "Cron"],
            "status": "Completed",
            "performance": "98.7%",
            "location": "US"
        },
    ...
    for i, project in enumerate(projects):
        with cols[i % 2]:
            st.markdown(f"""
            <div class="project-card" style="padding-bottom: 32px;">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 10px 20px; margin-top: 18px; margin-bottom: 24px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-bottom: 30px;">
            ...
            <div>
                ...
                <div style="margin-top: 20px;">
                    ...
                    <span style="background: rgba(255, 193, 7, 0.2); color: #FFC107; padding: 8px 15px; border-radius: 15px; font-size: 0.9rem; margin-left: 10px;">US</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-bottom: 30px;">
            ...
            <div>
                ...
                <div style="margin-top: 20px;">
                    ...
                    <span style="background: rgba(255, 193, 7, 0.2); color: #FFC107; padding: 8px 15px; border-radius: 15px; font-size: 0.9rem; margin-left: 10px;">UK</span>
                </div>
            </div>
        </div>
    </div>
    ...
    # Featured case study for the US Stock Market Trading Signal Automation project
    st.markdown("""
    <div style="background: rgba(255,255,255,0.05); border-radius: 20px; padding: 30px; border: 1px solid rgba(255,255,255,0.1); margin-top: 40px;">
        <h2 style="color: #667eea; margin-bottom: 20px; text-align: center;">Featured Project: US Stock Market Trading Signal Automation</h2>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-bottom: 30px;">
            <div>
                <h4 style="color: #667eea; margin-bottom: 15px;">Client: Private Trader</h4>
                <p style="color: #a8b2d1; line-height: 1.6; margin-bottom: 15px;">
                    Combined and refactored 11+ Python scripts into a single, clean, and optimized trading signal system. The solution scans all U.S. tickers under $10, applies multi-layered filters (liquidity, volume, price movement, cash/debt, margin), and sends entry, liquidity boost, and exit alerts to two Telegram channels. Deployed and tested the system on a Linux VPS (CyberPanel), ensuring robust background operation and easy maintenance.
                </p>
                <h5 style="color: #667eea; margin-bottom: 10px;">Key Features:</h5>
                <ul style="color: #a8b2d1; line-height: 1.8;">
    ...
    <div style="background: rgba(255,255,255,0.05); border-radius: 20px; padding: 30px; border: 1px solid rgba(255,255,255,0.1); margin-top: 40px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-bottom: 30px;">
            <div>
                ...
                <p style="color: #a8b2d1; line-height: 1.6; margin-bottom: 15px;">
                    Built a robust Python system for a US client to automate sports score predictions for NBA, NFL, and college games. The solution scrapes real-time stats, injuries, and expert picks, applies layered logic for predictions, and auto-updates daily. Delivered with a simple dashboard and full documentation.
                </p>
                <h5 style="color: #667eea; margin-bottom: 10px;">Key Features:</h5>
                <ul style="color: #a8b2d1; line-height: 1.8;">
...
# Contact Page
    ...
    with col1:
        ...
        <div style="background: rgba(255,255,255,0.05); border-radius: 20px; padding: 30px; border: 1px solid rgba(255,255,255,0.1);">
            ...
            <div style="margin-bottom: 15px;">
                <p style="color: #a8b2d1;"><strong>Phone/WhatsApp:</strong> +92 309 5183754, +92 316 1443727</p>
            </div>
            <div style="margin-bottom: 15px;">
            ...
            <div style="margin-bottom: 25px;">
                <a href="https://wa.me/923095183754" target="_blank" style="text-decoration: none;">
                    <button style="background-color:#25D366;color:white;padding:10px 24px;border:none;border-radius:8px;font-size:1.1rem;cursor:pointer;margin-bottom:10px;">
                        Contact on WhatsApp (+92 309 5183754)
                    </button>
                </a><br/>
                <a href="https://wa.me/923161443727" target="_blank" style="text-decoration: none;">
                    <button style="background-color:#25D366;color:white;padding:10px 24px;border:none;border-radius:8px;font-size:1.1rem;cursor:pointer;">
                        Contact on WhatsApp (+92 316 1443727)
                    </button>
                </a>
            </div>
        </div>
...
# ---
# Gmail API Setup Instructions (one-time, manual):
...
# 6. The first time you submit the form, a browser window will open for you to log in and authorize access.
# 7. A token.json file will be created for future use.
