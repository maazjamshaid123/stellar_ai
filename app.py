...
def get_visit_count():
    ...
    try:
        if os.path.exists('visit_counter.json'):
...
def increment_visit_count():
    """Increment the visit count and save to file"""
    try:
...
<div class="visit-counter">
    <div style="text-align: center;">
        <div style="color: #667eea; font-size: 1.2rem; font-weight: bold;">👥</div>
        <div style="color: #ffffff; font-size: 1.1rem; font-weight: bold;">{visit_count:,}</div>
        <div style="color: #a8b2d1; font-size: 0.8rem;">Visits</div>
    </div>
</div>
""", unsafe_allow_html=True)
...
if selected == "Home":
    ...
    <style>
        @keyframes planetFloat1a {
            0% {
                transform: translateX(-100px) translateY(100vh) scale(0.8);
                opacity: 0;
            }
            10% {
                opacity: 1;
        ...
        @keyframes planetFloat1b {
            0% {
                transform: translateX(calc(100vw + 100px)) translateY(50vh) scale(0.9);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(-100px) translateY(20vh) scale(1.1);
                opacity: 0;
            }
        }
        
        @keyframes planetFloat1c {
            0% {
                transform: translateX(50vw) translateY(-100px) scale(0.7);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(20vw) translateY(calc(100vh + 100px)) scale(1.3);
                opacity: 0;
            }
        }
        
        @keyframes planetFloat2a {
            0% {
                transform: translateX(calc(100vw + 100px)) translateY(-100px) scale(0.9);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(-100px) translateY(calc(100vh + 100px)) scale(1.1);
                opacity: 0;
            }
        }
        
        @keyframes planetFloat2b {
            0% {
                transform: translateX(-100px) translateY(30vh) scale(1.0);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(calc(100vw + 100px)) translateY(70vh) scale(0.8);
                opacity: 0;
            }
        }
        
        @keyframes planetFloat2c {
            0% {
                transform: translateX(80vw) translateY(calc(100vh + 100px)) scale(0.8);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(10vw) translateY(-100px) scale(1.2);
                opacity: 0;
            }
        }
        
        @keyframes planetFloat3a {
            0% {
                transform: translateX(50vw) translateY(-100px) scale(0.7);
                opacity: 0;
            }
        ...
        @keyframes planetFloat3b {
            0% {
                transform: translateX(-100px) translateY(40vh) scale(1.1);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(calc(100vw + 100px)) translateY(60vh) scale(0.9);
                opacity: 0;
            }
        }
        
        @keyframes planetFloat3c {
            0% {
                transform: translateX(calc(100vw + 100px)) translateY(20vh) scale(0.8);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(-100px) translateY(80vh) scale(1.2);
                opacity: 0;
            }
        }
        
        @keyframes planetFloat4a {
            0% {
                transform: translateX(-100px) translateY(50vh) scale(1.1);
                opacity: 0;
            }
            10% {
                opacity: 1;
        ...
        @keyframes planetFloat4b {
            0% {
                transform: translateX(calc(100vw + 100px)) translateY(80vh) scale(0.9);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(-100px) translateY(10vh) scale(1.2);
                opacity: 0;
            }
        }
        
        @keyframes planetFloat4c {
            0% {
                transform: translateX(30vw) translateY(calc(100vh + 100px)) scale(1.0);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(70vw) translateY(-100px) scale(0.9);
                opacity: 0;
            }
        }
        
        @keyframes planetFloat5a {
            0% {
                transform: translateX(calc(100vw + 100px)) translateY(80vh) scale(0.9);
                opacity: 0;
            }
        ...
        @keyframes planetFloat5b {
            0% {
                transform: translateX(-100px) translateY(20vh) scale(1.0);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(calc(100vw + 100px)) translateY(90vh) scale(0.8);
                opacity: 0;
            }
        }
        
        @keyframes planetFloat5c {
            0% {
                transform: translateX(60vw) translateY(-100px) scale(0.7);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(10vw) translateY(calc(100vh + 100px)) scale(1.3);
                opacity: 0;
            }
        }
        
        @keyframes planetFloat6a {
            0% {
                transform: translateX(30vw) translateY(calc(100vh + 100px)) scale(1.0);
                opacity: 0;
            }
        ...
        @keyframes planetFloat6b {
            0% {
                transform: translateX(-100px) translateY(70vh) scale(0.8);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(calc(100vw + 100px)) translateY(30vh) scale(1.2);
                opacity: 0;
            }
        }
        
        @keyframes planetFloat6c {
            0% {
                transform: translateX(calc(100vw + 100px)) translateY(10vh) scale(1.1);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(-100px) translateY(90vh) scale(0.9);
                opacity: 0;
            }
        }
        
        @keyframes rocketFloat1a {
            0% {
                transform: translateX(-100px) translateY(60vh) rotate(45deg) scale(0.8);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(calc(100vw + 100px)) translateY(20vh) rotate(45deg) scale(1.3);
                opacity: 0;
            }
        }
        
        @keyframes rocketFloat1b {
            0% {
                transform: translateX(calc(100vw + 100px)) translateY(40vh) rotate(-45deg) scale(0.9);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(-100px) translateY(80vh) rotate(-45deg) scale(1.2);
                opacity: 0;
            }
        }
        
        @keyframes rocketFloat1c {
            0% {
                transform: translateX(50vw) translateY(-100px) rotate(30deg) scale(0.7);
                opacity: 0;
            }
            10% {
                opacity: 1;
            ...
            100% {
                transform: translateX(20vw) translateY(calc(100vh + 100px)) rotate(30deg) scale(1.3);
                opacity: 0;
            }
        }
        ...
        @keyframes planetGlow {
            0%, 100% {
                filter: drop-shadow(0 0 8px rgba(102, 126, 234, 0.6)) drop-shadow(0 0 15px rgba(102, 126, 234, 0.4));
            }
            50% {
                filter: drop-shadow(0 0 12px rgba(102, 126, 234, 0.8)) drop-shadow(0 0 20px rgba(102, 126, 234, 0.6)) drop-shadow(0 0 30px rgba(118, 75, 162, 0.4));
            }
        }
        
        @keyframes rocketGlow {
            0%, 100% {
                filter: drop-shadow(0 0 10px rgba(255, 100, 100, 0.7)) drop-shadow(0 0 20px rgba(255, 100, 100, 0.5));
            }
            50% {
                filter: drop-shadow(0 0 15px rgba(255, 100, 100, 0.9)) drop-shadow(0 0 25px rgba(255, 100, 100, 0.7)) drop-shadow(0 0 35px rgba(255, 150, 100, 0.5));
            }
        }
        ...
        .planet-1 {
            animation: planetFloat1a 8s ease-in-out infinite, planetGlow 2s ease-in-out infinite alternate;
            animation-delay: 0s;
        }
        
        .planet-2 {
            animation: planetFloat2a 10s ease-in-out infinite, planetGlow 2s ease-in-out infinite alternate;
            animation-delay: 2s;
        }
        
        .planet-3 {
            animation: planetFloat3a 12s ease-in-out infinite, planetGlow 2s ease-in-out infinite alternate;
            animation-delay: 4s;
        }
        
        .planet-4 {
            animation: planetFloat4a 9s ease-in-out infinite, planetGlow 2s ease-in-out infinite alternate;
            animation-delay: 6s;
        }
        
        .planet-5 {
            animation: planetFloat5a 11s ease-in-out infinite, planetGlow 2s ease-in-out infinite alternate;
            animation-delay: 8s;
        }
        
        .planet-6 {
            animation: planetFloat6a 13s ease-in-out infinite, planetGlow 2s ease-in-out infinite alternate;
            animation-delay: 10s;
        }
        ...
        .rocket {
            position: absolute;
            font-size: 2.2rem;
            animation: rocketGlow 1.5s ease-in-out infinite alternate;
            transition: transform 0.1s ease-out;
        }
        
        .rocket-1 {
            animation: rocketFloat1a 7s ease-in-out infinite, rocketGlow 1.5s ease-in-out infinite alternate;
            animation-delay: 3s;
        }
    ...
    <script>
        ...
        class SpaceObject {
            constructor(element, x, y, vx, vy, size) {
            ...
            checkCollision(other) {
                ...
                if (distance < minDistance * 1.2 && this.bounceCount < this.maxBounces && other.bounceCount < other.maxBounces) {
                    ...
                    // Swap velocities with some randomization
                    const tempVx = this.vx;
                    const tempVy = this.vy;
                    this.vx = other.vx * 0.9 + (Math.random() - 0.5) * 3;
                    this.vy = other.vy * 0.9 + (Math.random() - 0.5) * 3;
                    other.vx = tempVx * 0.9 + (Math.random() - 0.5) * 3;
                    other.vy = tempVy * 0.9 + (Math.random() - 0.5) * 3;
                    
                    // Add bounce effect with more visible animation
                    this.element.style.animation = 'bounce 0.5s ease-out';
                    other.element.style.animation = 'bounce 0.5s ease-out';
                    
                    // Add temporary glow effect for collision
                    this.element.style.filter = 'drop-shadow(0 0 20px rgba(255, 255, 0, 0.8))';
                    other.element.style.filter = 'drop-shadow(0 0 20px rgba(255, 255, 0, 0.8))';
                    
                    setTimeout(() => {
                        this.element.style.animation = '';
                        other.element.style.animation = '';
                        // Restore original glow
                        this.element.style.filter = 'drop-shadow(0 0 8px rgba(102, 126, 234, 0.6))';
                        other.element.style.filter = 'drop-shadow(0 0 8px rgba(102, 126, 234, 0.6))';
                    }, 500);
        ...
        setTimeout(function() {
            ...
            var allObjects = [...planets, ...rockets];
            var spaceObjects = [];
            
            // Create physics objects
            allObjects.forEach(function(obj, index) {
                const size = 50; // Larger collision size for better detection
                const x = Math.random() * (window.innerWidth - size);
                const y = Math.random() * (window.innerHeight - size);
                const vx = (Math.random() - 0.5) * 6; // Faster velocity
                const vy = (Math.random() - 0.5) * 6;
                
                // Completely remove all CSS animations and set initial position
                obj.style.animation = 'none';
                obj.style.animationName = 'none';
                obj.style.animationDuration = '0s';
                obj.style.animationDelay = '0s';
                obj.style.animationIterationCount = '0';
                obj.style.transform = `translate(${x}px, ${y}px)`;
                
                // Add glow effect back manually
                obj.style.filter = 'drop-shadow(0 0 8px rgba(102, 126, 234, 0.6))';
                
                spaceObjects.push(new SpaceObject(obj, x, y, vx, vy, size));
            });
            ...
            function animate() {
                ...
                for (let i = 0; i < spaceObjects.length; i++) {
                    for (let j = i + 1; j < spaceObjects.length; j++) {
                        spaceObjects[i].checkCollision(spaceObjects[j]);
                    }
                }
    ...
    # Fiverr Profile Button on Home Page
    st.markdown("""
    <div style="text-align: center; margin: 60px 0 40px 0;">
        <div style="background: rgba(255,255,255,0.05); border-radius: 20px; padding: 40px; border: 1px solid rgba(255,255,255,0.1); backdrop-filter: blur(10px);">
            <h2 style="color: #667eea; margin-bottom: 20px; font-size: 2rem;">Ready to Start Your AI Project?</h2>
            <p style="color: #a8b2d1; margin-bottom: 30px; line-height: 1.6; font-size: 1.1rem; max-width: 600px; margin-left: auto; margin-right: auto;">
                Transform your ideas into reality with cutting-edge AI solutions. From machine learning models to automated trading systems, 
                I deliver professional results that drive business growth.
            </p>
            <a href="https://www.fiverr.com/s/8zD43Gr" target="_blank" style="text-decoration: none;">
                <button style="
                    ...
                    margin: 10px;
                " onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 8px 25px rgba(29, 191, 115, 0.4)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 6px 20px rgba(29, 191, 115, 0.3)'">
                    🚀 Hire Me on Fiverr
                </button>
            </a>
            <div style="margin-top: 20px;">
                <span style="background: rgba(102, 126, 234, 0.2); color: #667eea; padding: 8px 16px; border-radius: 20px; font-size: 0.9rem; margin: 0 5px;">AI Development</span>
                <span style="background: rgba(118, 75, 162, 0.2); color: #764ba2; padding: 8px 16px; border-radius: 20px; font-size: 0.9rem; margin: 0 5px;">Machine Learning</span>
                <span style="background: rgba(255, 193, 7, 0.2); color: #FFC107; padding: 8px 16px; border-radius: 20px; font-size: 0.9rem; margin: 0 5px;">Trading Algorithms</span>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
# Contact Page
    ...
    <div style="text-align: center; margin: 40px 0;">
        <div style="background: rgba(255,255,255,0.05); border-radius: 20px; padding: 30px; border: 1px solid rgba(255,255,255,0.1);">
            <h3 style="color: #667eea; margin-bottom: 20px;">Hire Me on Fiverr</h3>
            <p style="color: #a8b2d1; margin-bottom: 25px; line-height: 1.6;">
                Ready to bring your AI vision to life? Check out my Fiverr profile for custom AI solutions, 
                machine learning projects, and innovative technology development.
            </p>
            <a href="https://www.fiverr.com/s/8zD43Gr" target="_blank" style="text-decoration: none;">
                <button style="
                    background: linear-gradient(90deg, #1DBF73 0%, #19A463 100%);
                ...
                " onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 6px 20px rgba(29, 191, 115, 0.4)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(29, 191, 115, 0.3)'">
                    🚀 View My Fiverr Profile
                </button>
            </a>
            <p style="color: #8892b0; margin-top: 15px; font-size: 0.9rem;">
                Professional AI & Machine Learning Services
            </p>
        </div>
    </div>
    """, unsafe_allow_html=True)
